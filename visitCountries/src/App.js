...
import MapImage from './component/Map'
...
class App extends Component {
  ...
  visitedCountryList = data => {
    // this.setState(prevState => ({
    //   visitedList: [...prevState.visitedList, data],
    // }))
    this.setState(prevState => ({
      visitedList: [
  ...
  removeCountry = data => {
    this.setState(prevState => ({
      visitedList: prevState.visitedList.filter(
        eachVisitedCountry => eachVisitedCountry.id !== data.id,
      ),
    }))
    this.setState(prevState => ({
      //   visitedList: [
    ...
    return (
      <div className="bg-container">
        ...
        <ul className="countries-container">
          {countriesList.map(eachCountry => (
            <li key={eachCountry.id}>
              <VisitedCountry
                eachCountryList={eachCountry}
                visitedCountryList={this.visitedCountryList}
              />
            </li>
          ))}
        </ul>
        ...
        <ul>
          ...
          {visitedList.map(eachVisitedCountry => (
            <li key={eachVisitedCountry.id}>
              <MapImage
